              ...
              <!-- Collect the nav links, forms, and other content for toggling -->
                   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                           <a class="dropdown-toggle" data-toggle="dropdown" href="#">User lists
            ...
            <div class="row pad-top-30">
                <div class="inner-page col-md-12">
                    <div id="about" class="well">
                        <h3>About Mission Statement</h3>
                        <p>The four different blood groups are A, B, AB and O, and each type is either Rh-positive or Rh-negative. O negative blood can be given to anybody if necessary, but it is always preferable to match the exact blood group to prevent dangerous reactions. Healthy adults are able to donate blood and the procedure is safe and relatively painless. During a regular donation, you will give around 470 ml of whole blood. This is about eight per cent of the average adult’s blood volume. The body replaces this volume within 24 to 48 hours, and replenishes red blood cells in 10 to 12 weeks. Your donation of blood is usually separated into different components, because people receiving blood generally need a specific component, rather than whole blood.</p>
        ...
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
              Cardiovascular disease (Blood disease)
          </a>
      </h4>
  </div>
